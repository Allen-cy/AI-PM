...
test("V6.6.1 release derives browser version metadata from package.json", () => {
  ...
  assert.equal(packageMetadata.version, "6.6.1");
...
test("README leads with the V6.6.1 release and preserves prior release order", () => {
