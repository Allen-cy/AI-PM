...
test("V6.6.5 release derives browser version metadata from package.json", () => {
  ...
  assert.equal(packageMetadata.version, "6.6.5");
...
test("README leads with the V6.6.5 release and preserves prior release order", () => {
