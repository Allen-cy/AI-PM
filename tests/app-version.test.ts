...
test("V6.4.0 release derives browser version metadata from package.json", () => {
  ...
  assert.equal(packageMetadata.version, "6.4.0");
...
test("README leads with the V6.4.0 release and preserves prior release order", () => {
