...
test("V6.3.0 release derives browser version metadata from package.json", () => {
  ...
  assert.equal(packageMetadata.version, "6.3.0");
...
test("version resolver normalizes the public version and short commit label", async () => {
  ...
  assert.deepEqual(resolveAppVersion({
    NEXT_PUBLIC_APP_VERSION: "6.3.0",
    NEXT_PUBLIC_GIT_COMMIT_SHA: "0123456789abcdef",
  }), {
    version: "6.3.0",
    commit: "0123456",
    label: "V6.3.0 · 0123456",
  });
...
test("README leads with the V6.3.0 release instead of V6.2.0", () => {
  ...
  assert.ok(v630 < v620, "V6.3.0 release notes must appear before V6.2.0");
});
