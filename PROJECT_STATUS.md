...
> 当前发布候选：V6.6.5 | 更新日期：2026-07-16 | 阶段：正式试点数据治理工具完成，等待真实受控试点

V6.6.5统一生产验收口径：V6.6.4治理台和启动包保持不变，生产治理API最终输出为237条待治理记录、230条样例建议、7条人工判断、0条正式候选；此前“234条带字样、3条同步账本”的数字属于原始载荷启发式扫描，不能代替白名单分类器结果。组织级PMO可下载UTF-8 BOM中文CSV，在飞书按“正式/样例/测试/诊断”补齐字段后重新对账。系统不会把这些记录冒充为五个真实项目。本补丁不新增数据库对象，继续复用47份既有migration与安全门禁。正式试点仍需5个真实项目、4位不同真实人员本人签署、黄金链A/E、三类飞书回执和一次真实失败恢复。历史V3.0报告保留在下方，仅作产品演进记录。
