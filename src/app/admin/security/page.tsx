            ...
            <section style={{ ...cardStyle, gridColumn: "1 / -1" }}>
              ...
              <div style={{ marginTop: 18, paddingTop: 16, borderTop: "1px solid var(--border)" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(4,minmax(0,1fr))", gap: 9 }}>
                  ...
                  <button className="btn-primary" onClick={() => void assignReportingRelationship()} disabled={saving || !reportingDraft.subjectId || !reportingDraft.fromUserId || !reportingDraft.toUserId || reportingDraft.fromUserId === reportingDraft.toUserId} style={{ alignSelf: "end", minHeight: 38 }}>建立汇报关系</button>
                </div>
