...
export function createDashboardTemplateWorkbook(): Buffer {
  ...
  const rows = [
    ['PMO-2026-001', '江苏', '智慧校园一期', '某市教育局', '执行中', 'A', '信息化', '智慧作业', '2026-01-15', '2026-01-20', '2026-07-30', 0.62, 280, 120, 160, 82, -6, '进度风险', '中', '监控中', '平稳', '2026-07-30'],
    ['PMO-2026-002', '河南', '质量监测平台', '某省教研院', '验收中', 'S', '信息化', '质量监测', '2026-02-20', '2026-02-28', '2026-06-30', 0.95, 420, 300, 120, 88, 2, '回款风险', '中', '处理中', '改善', '2026-06-30'],
  ];
